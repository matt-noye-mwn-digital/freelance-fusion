...
@section('content')
    ...
    <section class="pageMain">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin.billing.expenses.store') }}" method="post" class="createEditForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <x-forms.text-input-field label="Amount" name="amount" type="number" required="true"/>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label for="category_id">Expense Category <span>*</span></label>
